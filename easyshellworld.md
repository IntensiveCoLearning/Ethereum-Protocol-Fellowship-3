...
* **Gasper**
  * Gasper 是将 LMD GHOST 分叉选择算法与 Casper FFG 最终确定性机制相结合的共识协议。它结合了两者的优势，确保了以太坊权益证明区块链的安全性和活性。Gasper 定义了验证者如何受到奖励和惩罚，决定了接受和拒绝哪些区块，以及在区块链分叉上如何构建区块。citeturn0search0 
